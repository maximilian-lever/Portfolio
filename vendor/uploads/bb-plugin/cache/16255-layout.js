...
!function (name, definition) {
  ...
  var wpAjaxUrl = 'https://templates.ultimatebeaver.com/wp-admin/admin-ajax.php';var flBuilderUrl = 'https://templates.ultimatebeaver.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
      ...
      paths : {
          pluginUrl : 'https://templates.ultimatebeaver.com/wp-content/plugins/bb-plugin/',
          wpAjaxUrl : 'https://templates.ultimatebeaver.com/wp-admin/admin-ajax.php'
      },
      breakpoints : {
          small  : 768,
          medium : 992	},
  ...
  (function($) {
    ...
    jQuery( document ).ready(function($) {
        new UABBFancyText({
          ...
          viewport_position:  90,
          animation:          'type',
          strings:            ["Design","Coding","Hosting","Maintenance"],//TEXT
          typeSpeed:          80,
          startDelay:         200,
          backSpeed:          50,
          backDelay:          2000,
  ...
  jQuery(document).ready(function($){
      if( 'function' == typeof UABBModalPopup ) {
          var UABBModalPopup_58b0153b9a13b =  new UABBModalPopup({
              id: '58b0153b9a13b',
              modal_on: 'custom',
              modal_custom: '.web-agency-video',
              ...
              small_device: '768',
                      ...
                      setTimeout(function(){
                  $(".uamodal-58b0153b9a13b .uabb-modal-content-data").fitVids();
              }, 300);
          
          /*			var custom_wrap = $(".web-agency-video");
  
              custom_wrap.addClass("uabb-modal-action uabb-trigger");
              custom_wrap.attr( 'data-modal', "modal-58b0153b9a13b" );
          */
          
          
          //console.log( e );
          //console.log( UABBModalPopup_58b0153b9a13b );
      }
  });
